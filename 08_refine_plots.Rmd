...
```{r, fig.cap="RColorBrewer's qualitative palettes.", fig.width=4, fig.height=4}
library(RColorBrewer)
display.brewer.all(type = "qual")
```


```{r, fig.cap='Some available palettes in use.', fig.width=5, fig.height=4, fig.show = "hold"}
...
```{r, fig.cap='Using a custom color palette.', fig.width=8, fig.height=6}
...
```{r, fig.width=5, fig.height=6, fig.show = "hold", fig.cap = "Comparing a default color palette with an approximation of how the same palette appears to people with one of three kinds of color blindness."}
