...
```{r, fig.cap='Improving the projection', out.width="100%", fig.width=6, fig.height=5}
...
```{r, fig.cap='Mapping the results', out.width="100%", fig.width=6, fig.height=5}
...
```{r, fig.cap='Two versions of Percent Trump by State', out.width="100%", fig.width=6, fig.height=5, fig.show = 'hold'}
...
```{r, fig.cap='Two views of Trump vs Clinton share: a white midpoint, and a Purple America version.', out.width="100%", fig.width=6, fig.height=5, fig.show = "hold"}
...
```{r, fig.cap='A Purple America version of Trump vs Clinton that excludes results from Washington, DC.', out.width="100%", fig.width=6, fig.height=5}
...
```{r, fig.cap='Statebins of the election results. We omit DC from the Clinton map to prevent the scale becoming unbalanced.', warning = FALSE, out.width = "100%", fig.show = "hold", fig.margin = TRUE, fig.width = 5, fig.height = 4, tidy = FALSE}
library(statebins)
...
```{r, fig.cap='Manually specifying colors for statebins.', warning = FALSE, out.width = "100%", fig.show = "hold", fig.margin = TRUE, fig.width = 5, fig.height = 4, tidy = FALSE}
...
```{r, fig.cap='All the states at once.', out.width="100%", fig.width=11, fig.height=8.5}
